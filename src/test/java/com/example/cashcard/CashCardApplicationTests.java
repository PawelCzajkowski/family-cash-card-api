...
class CashCardApplicationTests {
	...
	@Test
	void shouldReturnASortedPageOfAllCashCardsWithNoParametersInRequest() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.getForEntity("/cashcards", String.class);
	...
	void shouldRejectUsersWhoAreNotCardOwners() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("hank-owns-no-cards", "xyz456")
				.getForEntity("/cashcards/99", String.class);
	...
	void shouldNotUpdateACashCardOwnedBySomeoneElse() {
		...
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.exchange("/cashcards/102", HttpMethod.PUT, request, Void.class); // kumar2's data
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
